...
StartupEvents.registry('item', event => { // Register new items here event.create('example_item').displayName('Example Item')
	...
	*/
	...
	event.create('finality:omnipotent_alloy').texture('finality:item/final_ingot').displayName('High Entropy Alloy').maxStackSize(64).group('miscellaneous')
	// tools
	...
	// armor
	event.create('finality:final_helmet', 'helmet').tier('final_armor').displayName('Conscientia Oculi').texture('finality:textures/models/final_armor').maxStackSize(1).group('combat')
	event.create('finality:final_chestplate', 'chestplate').tier('final_armor').displayName('Vitale Cordis').texture('finality:textures/models/final_armor').maxStackSize(1).group('combat')
	event.create('finality:final_leggings', 'leggings').tier('final_armor').displayName('Universum Motus').texture('finality:textures/models/final_armor').maxStackSize(1).group('combat')
	event.create('finality:final_boots', 'boots').tier('final_armor').displayName('Gravitas Anchoram').texture('finality:textures/models/final_armor').maxStackSize(1).group('combat')
})
